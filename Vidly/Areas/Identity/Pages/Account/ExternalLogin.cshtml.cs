...
namespace Vidly.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<VidlyIdentityUser> _signInManager;
        private readonly UserManager<VidlyIdentityUser> _userManager;
        private readonly IUserStore<VidlyIdentityUser> _userStore;
        private readonly IUserEmailStore<VidlyIdentityUser> _emailStore;
        private readonly IEmailSender _emailSender;
        private readonly ILogger<ExternalLoginModel> _logger;

        public ExternalLoginModel(
            SignInManager<VidlyIdentityUser> signInManager,
            UserManager<VidlyIdentityUser> userManager,
            IUserStore<VidlyIdentityUser> userStore,
        ...
        private IUserEmailStore<VidlyIdentityUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<VidlyIdentityUser>)_userStore;
        }
    }
}
